...
public class SimpleTableView: View, ComponentDefinitionContainer {
    ...
    public override func initialize() throws -> UIView {
        ...
        let tableView = Reactant.SimpleTableView<CellHack, CellHack, CellHack>(
            cellFactory: {
    ...
    .with(state: .items(Array(repeating: SectionModel(model: (header: (), footer: ()), items: Array(repeating: (), count: itemCount)), count: sectionCount)))
